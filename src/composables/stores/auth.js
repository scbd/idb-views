...
function loadIframe(){
  ...
  if(!this.accountsUrl) throw new Error('@scbd/idb-views.composables.stores.auth.loadIframe: no accountsUrl given to auth store state');
...
function receivePostMessage(event){
  ...
  if(type!=='authenticationToken') throw new Error('@scbd/idb-views.composables.stores.auth.receivePostMessage: unsupported authentication message type');
